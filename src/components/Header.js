...
export default function Header() {
  ...
  const [activeSection, setActiveSection] = useState(""); // Suivi de la section active
  ...
  useEffect(() => {
    ...
    }, { threshold: 0.5 }); // Observer quand 50% de la section est visible
  ...
  const getLinkClass = (path) => {
    return activeSection === path || router.asPath === `#${path}`
      ? "text-[#8D448B] hover:text-secondary active:text-secondary"  // Nouvelle couleur active
  ...
  return (
    ...
    >
      <div className="container mx-auto px-6 md:px-10 lg:px-10 flex justify-between items-center">
        ...
        >
          ...
          <nav className="flex flex-col space-y-6 py-8 px-6">
            <Link href="#hero" scroll={false} className={getLinkClass("hero")}>
              Home
            </Link>
            <Link href="#services" scroll={false} className={getLinkClass("services")}>
              Services
            </Link>
            <Link href="#testimonials" scroll={false} className={getLinkClass("testimonials")}>
              Testimonials
            </Link>
            <Link href="#news" scroll={false} className={getLinkClass("news")}>
              News
            </Link>
          </nav>
